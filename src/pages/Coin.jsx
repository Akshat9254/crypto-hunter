    ...
    <div className={classes.container}>
      <div className={classes.sidebar}>
        ...
        >
          ...
          {/* {HTMLReactParser(coin?.description?.en?.spilt('. ')[0])} */}
        </Typography>
      ...
      <div className={classes.marketData}>
        ...
        <span style={{display: 'flex'}}>
          ...
          &nbsp;&nbsp;
          <Typography variant='h5' style={{fontFamily: 'Montserrat'}}>{currencySymbol} {numberWithCommas(coin?.market_data.current_price[currency.toLowerCase()])}</Typography>
        </span>
        <span style={{display: 'flex'}}>
          <Typography variant='h5' className={classes.heading}>Market Cap:</Typography>
          &nbsp;&nbsp;
          <Typography variant='h5' style={{fontFamily: 'Montserrat'}}>{currencySymbol} {numberWithCommas(coin?.market_data.market_cap[currency.toLowerCase()].toString().slice(0, -6))}M</Typography>
        </span>
